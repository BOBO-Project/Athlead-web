    ...
    <div id='footer'>
      <div className='footer-wrapper'>
        ...
        <div className='third'>
          ...
          <p className='sub-title'>{translate("product-content-photographer")}</p>
        ...
        <div className='forth'>
          ...
          <p className='sub-title'>{translate("other-content-chat")}</p>
        </div>
        <div className='fifth'>
          ...
          <p className='content'>
            ...
            Khusus Ibukota Jakarta 12130</p>
      ...
      <div className='created'>
        <p>PT Kita Athlead Indonesia <span>&#169;</span> All Right Reserved 2022</p>
      </div>
    </div>
  )
}
